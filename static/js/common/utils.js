...
export function fixRussianPrepositions() {
    document.querySelectorAll('p, h1, h2, h3, .text').forEach(el => {
        el.innerHTML = el.innerHTML.replace(/(\s(в|на|с|о|к|у|за|и|для|или|без|до|по|из|от|под|над))\s/gi, '$1&nbsp;');
    });
}