...
export function initDropdownToggle(buttonId, wrapperId) {
    ...
    function close() {
        ...
        // Очищаем поле поиска внутри дропдауна и сбрасываем фильтрацию списка,
        // чтобы при следующем открытии не оставался старый запрос
        const searchInput = wrapper.querySelector('input.search__input');
